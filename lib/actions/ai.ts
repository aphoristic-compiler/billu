...
15. OUTCOME SIMULATIONS: If the user asks to 'simulate a match' or predict the outcome between players/teams, you MUST use the simulate_match_odds tool. DO NOT call start_cricket_match or split_cricket_teams for a simulation unless they explicitly want to start a real match.`;
